...
go
Select CONCAT(c.Provincia,c.Canton,c.Distrito)[Codigo],a.Nombre[Provincia],b.Nombre[Canton],c.Nombre[Canton]
from Provincia a 
inner join Canton b on a.Cod=b.Provincia 
inner join Distrito c on b.Provincia=c.Provincia and b.Canton=c.Canton
go
Select * from Canton where Provincia=2
go
Select * from CDE_BD..Canton where numeroProvincia=2
go
Select Provincia,Count(*) from Distrito group by Provincia
go

Select numeroProvincia,Count(*) from CDE_BD..Distrito group by numeroProvincia